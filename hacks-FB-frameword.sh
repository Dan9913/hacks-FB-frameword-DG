...
echo -e $i"\t\t |"$me"─────────────────────────────────────────────"$i"|"
echo -e $i"\t\t |"$pu" AUTHOR :"$ku" Sheik-Dego"$i"                      |"
echo -e $i"\t\t |"$pu" FACEBOOK :"$ku" CARLOS MAX"$i"                    |"
echo -e $i"\t\t |"$cy" ~ #!/user/bin/env python "$i"    ~              |"
echo -e $i"\t\t |"$cy" ~ print(" The Cyber Warrior ")"$i" ~              |"
echo -e $i"\t\t |"$pu" GitHub :"$ku" https://github.com/dego905"$i"        |"
echo -e $i"\t\t |"$pu" Contack Gmail :"$ku" degomax9@gmail.com"$i"        |"
echo -e $i"\t\t["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo -e $i"────────────────────────────────   "                               $i"────────────────────────────────"$i"    "$cy" "$i" "
